...
\renewcommand{\publ}{\flushleft\footnotesize{Based on:\\[0.1cm]
		\textit{``Investigating instability architectural smells evolution: an exploratory case study''} \\[0.1cm]
}}

\chapter{Investigating instability architectural smells evolution: an exploratory case study}\label{chap:3}
...
\section{Related work}\label{c3:sec:related-work}
...
\subsubsection{Hublike dependency (HL)}\label{c3:sec:arch-smells-hl}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.85\linewidth}
		\centering
		\includegraphics[width=0.7\linewidth]{c3/architectural-smells-unstable-dep.pdf}
	...
	\begin{subfigure}[b]{0.85\linewidth}
		\centering
		\includegraphics[width=0.7\linewidth]{c3/architectural-smells-hublike-dep.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{c3/cycle-shapes.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c3/data-collection-process-pager.pdf}
...
%     \caption{Jaccard similarity scores for each pair of smell size (up until 16 and 10). The linking intervals are shown in red squares. In the figure it is assumed that the elements affected are always the same.}\label{c3:fig:jaccard-scores}
% \end{figure}

\section{General results}\label{c3:sec:general-results}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{c3/descriptive-smell-density.pdf}
...
\begin{figure}[]
    \centering
    \includegraphics[width=\textwidth,trim={0.2cm 0 0 0},clip]{c3/dynamic-time-warping-min-1line.pdf}
...
\begin{figure}[t]
    ...
    \begin{subfigure}[]{.8\textwidth}
        \centering
        \includegraphics[width=\linewidth,trim={6cm 6cm 6cm 6cm}, clip]{c3/signal-trend-legend.pdf}
    \end{subfigure}
	\hfill \\
    \begin{subfigure}[]{.8\textwidth}
        \centering
        \includegraphics[width=\linewidth]{c3/signal-trend-all-projects-oneplot.pdf}
    \end{subfigure}
...
\section{Survival analysis (RQ2a,b,c)}\label{c3:sec:rq2-results}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}[]{.7\textwidth}
        \centering
        \includegraphics[width=\linewidth, trim={0 0.8cm 0 1cm}, clip]{c3/survival-probabilities-selection.pdf}
        \caption{Smells of different types affecting classes or packages.}
        \label{c3:fig:survival-smells} 
    \end{subfigure} \hfill \\
    \begin{subfigure}[]{.7\textwidth}
        \centering
        \includegraphics[width=\linewidth, trim={0 0.8cm 0 1cm}, clip]{c3/survival-probabilities-shapes-selection.pdf}
...
Regarding instead the cycles Arcan could not classify into definite shapes, they have a more consistent trend and disappear quicker than all other shapes.
...
%\section{Discussion}\label{c3:sec:discussion}
