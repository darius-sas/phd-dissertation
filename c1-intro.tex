...
% Properly understanding AS will allow software practitioners to better manage TD.
% In the upcoming sections, I further elaborate on the why and how this is true
% AS are the main topic of this dissertation, while TD is the leitmotifs
%
