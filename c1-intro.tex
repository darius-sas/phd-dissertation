...
The smells detected need to be quantified in terms of TD, prioritised, monitored and paid back in order for AS management to be effective.
...
This means that TD management decisions are affected by other qualities as well, and to better understand to implications of these trade-offs I formulated RQ6: \textit{``How are trade-offs between quality attributes currently managed by the industry?''}
