...
%This is a rather resource-consuming process, and despite the many benefits it entails, practitioners can hardly apply it in practice due to the limited resources available.
%; a strong need for automating as much as possible the whole process is felt in this regard.
...
Indeed, a PhD project starts with an initial design problem that can be expressed as a problem statement, which can be decomposed into new, smaller design problems and knowledge questions.
