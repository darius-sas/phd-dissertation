...
\subsubsection{Hublike dependency (HL)}\label{c2:sec:arch-smells-hl}
...
\begin{figure}
	...
	\begin{subfigure}[b]{0.85\linewidth}
		\centering
		\includegraphics[width=0.7\linewidth]{c2/architectural-smells-unstable-dep.pdf}
	...
	\begin{subfigure}[b]{0.85\linewidth}
		\centering
		\includegraphics[width=0.7\linewidth]{c2/architectural-smells-hublike-dep.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{c2/cycle-shapes.png}
