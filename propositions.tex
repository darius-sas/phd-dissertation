...
\item The number of artefacts affected by a Cyclic Dependency instance tends to stay constant over time. The opposite holds for Hublike Dependency smell, which grows in 65\% of the cases. {\color{teal}{Chapter 2}}
...
% These two are a bit out of context from what one would expect
